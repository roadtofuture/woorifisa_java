...
public class CityRepoTest {
	...
	public void sortTest() {
		...
		assertEquals(cities.size(), 237);
		assertEquals(cities.get(0).getName(), "Zibo");
		assertEquals(cities.get(236).getName(), "Abidjan");
	...
	public void pageTest() {
		...
		assertEquals(cities.get(0).getName(), "Zibo");
		assertEquals(cities.get(9).getName(), "Victoria");
		assertEquals(pages.getTotalPages(), 24);
		assertEquals(pages.getTotalElements(), 237);
	}
}
